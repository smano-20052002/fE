...
function AddContentComponent() {
  ...
  const handleEditButton = (materialId) => {
    ...
    setMaterialType(EditContent.materialTypeId)
                    ...
                    <ListGroup.Item>
                      <div>
                        <div class="row">
                          ...
                          <div class="col">
                            <button className='ms-1 ' onClick={() => handleEditButton(content.materialId)}   ><FaRegEdit /></button>
                            <button className='ms-1 ' onClick={() => handleDeleteClickOpen(content.materialId)}  ><MdOutlineDelete /></button>
                          </div>
                        </div>
                      </div>
